...
import static com.reactordevelopment.Imperium.MainActivity.SUBJECT_COLOR;
import static com.reactordevelopment.Imperium.MainActivity.SUBJECT_INCOME;
import static com.reactordevelopment.Imperium.MainActivity.TRUCE_TIMER;
import static com.reactordevelopment.Imperium.MainActivity.formatInt;
...
public class Player extends Game{
    ...
    public void turn(boolean runAi){
        Log.i("Humanity", "TurnLog: "+getName()+" is human: "+isHuman());
        recentWars = new ArrayList<>(0);
    ...
    public void addAlly(String tag){ diploList[1].add(tag);}
    public void removeAlly(String tag){ diploList[1].remove(tag); addTruce(tag);}
    ...
    public int[] attack(){
        ...
        if(attackScan()) {
            ...
            if (savedSelect[1].getTroops() == 0) {
                ...
                if(isFriendly(savedSelect[1].getCore())) {
